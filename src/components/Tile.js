    ...
    return (
        <Link to={link} className="group">
            <div className="aspect-h-1 aspect-w-1 w-full overflow-hidden rounded-lg bg-gray-500 xl:aspect-h-8 xl:aspect-w-7">
                <img src={image || "https://www.bookmychefs.com/uploads/dish/default_food.jpg"} alt={'image of ' + title} className="h-full w-full object-cover object-center duration-300 group-hover:scale-105 group-hover:-rotate-1" />
            </div>
