                ...
                <section className='col-span-2'>
                    <div className=" w-full max-w-7xl mx-auto transition duration-300">
                        <form className="w-full mx-auto grid grid-cols-2 gap-4 bg-gray-100 dark:bg-gray-900 p-4 rounded-lg">
                            ...
                            <input className="w-full rounded-lg bg-white dark:bg-black p-2 pl-4" id="forename" value={forename}/>
                            </div>

                            <div className='w-full'>
                            <label htmlFor='surname'>Surname</label>
                            <input className="w-full rounded-lg bg-white dark:bg-black p-2 pl-4" id="surname" value={surname}/>
                            </div>
                            ...
                            <input type="password" className="w-full rounded-lg bg-white dark:bg-black p-2 pl-4" id="passwordConfirm" value={passwordConfirm}/>
                            </div>
