            ...
            <div className="max-w-7xl mx-auto  p-6 lg:px-8">
                ...
                <div class="h-12 w-full bg-gray-50 dark:bg-gray-900 rounded-2xl flex pl-2 max-w-2xl">
                    ...
                    <button className="hover:scale-110 duration-300" onClick={() => { location.getGeolocation() }}>
                        <MapPinIcon class="h-6 w-6 text-red-600 mr-2" />
                        </button>
                    {/* Postcode Input */}
                    ...
                    {/* Search Button */}
                    <Link to="/restaurants" className={`${location.confirmed ? "pointer-events-auto bg-red-500 hover:bg-red-600" : "pointer-events-none opacity-0"} text-gray-50 px-8 rounded-r-2xl ml-auto flex items-center duration-300`}>Search</Link>
                </div>
                <p class="mt-2 mb-2 text-lg leading-8"><Link to="/login" className="underline hover:font-bold hover:text-red-500 duration-300">Login</Link> or <Link to="/signup" className="underline hover:font-bold hover:text-red-500 duration-300">Sign Up</Link></p>
            </div>
